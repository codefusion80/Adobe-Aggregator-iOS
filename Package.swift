...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/adobe/aepsdk-assurance-ios.git", exact: "5.0.3"),
        .package(url: "https://github.com/adobe/aepsdk-core-ios.git", exact: "5.8.0"),
        ...
        .package(url: "https://github.com/adobe/aepsdk-messaging-ios.git", exact: "5.11.0"),
